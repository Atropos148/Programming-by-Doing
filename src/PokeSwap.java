...
public class PokeSwap {
    public static void main(String[] args) {
        ...
        String[] pokeParty = { "PIKACHU", "GYARADOS", "GEODUDE", "CHARMELEON", "BUTTERFREE", "MANKEY" };
        ...
        if (choice == 3) {
            System.out.println(pokeParty[0] + " couldn't run. Skip a turn.");
